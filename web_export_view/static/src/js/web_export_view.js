    ...
    Sidebar.include({
        ...
        redraw: function () {
            ...
            if (self.getParent().ViewManager.active_view.type == 'list') {
            	//self.$el.find('.o_cp_sidebar').last().append(QWeb.render('WebExportTreeViewXls', {widget: self}));
        ...
        on_sidebar_export_treeview_xls: function () {
            ...
            console.log('export_rows',export_rows)
            console.log('export_rows',export_columns_names)
